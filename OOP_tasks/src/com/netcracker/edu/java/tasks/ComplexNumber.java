 ...
 *   <code>public ComplexNumberImpl();</code> (this default constructor is required by the testing system).</li>
...
//Getters and setters
	...
	double getIm();
	/**
	 * @return true if this complex number has only real part (otherwise false)
	 */
	boolean isReal();
	/**
	 ...
	 * Correct examples: "-5+2i", 1+i", "+4-i", "i", "-3i", "3". Incorrect examples: "1+2*i", "2+2".<br/>
...
//Methods of java.lang.Object and similar methods
	 ...
	 * i.e. the number of characters it their string representation is not limited 
	 ...
	 * @param other Any implementation of {@link ComplexNumber} interface
...
//Ordering methods
	 ...
	 * It's strongly recommended to use {@link Arrays} utility class here.<br/>
